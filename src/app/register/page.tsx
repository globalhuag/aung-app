        ...
        <div className="px-5 py-6">
          ...
          {step === 'otp' && (
            <>
              ...
              <div className="text-gray-400 text-xs text-center mb-2">{otp.length}/6 หลัก · <span style={{fontFamily:'Noto Sans Myanmar'}}>လုံး</span></div>
              <div className="text-center mb-3">
                <button
                  ...
                  {resendCooldown > 0
                    ? <>ส่งรหัสอีกครั้งใน {resendCooldown}s · <span style={{fontFamily:'Noto Sans Myanmar'}}>ပြန်ပို့ရန် {resendCooldown}s</span></>
                    : <>🔁 ส่งรหัสอีกครั้ง · <span style={{fontFamily:'Noto Sans Myanmar'}}>ထပ်ပို့</span></>}
                </button>
              </div>
